...
public class OrderItemEmployeeSide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderIdTv = (TextView)findViewById(R.id.employee_order_items_orderId);
        customerNameTv = (TextView)findViewById(R.id.employee_order_items_customer_name);
        customerEmailTv = (TextView)findViewById(R.id.employee_order_items_customer_email);
        handledByTv = (TextView)findViewById(R.id.employee_order_items_handledBy);
        statusTv = (TextView)findViewById(R.id.employee_order_items_status);
        slideButton = (SlideView)findViewById(R.id.employee_order_items_slider_button);

        mRecyclerView = (RecyclerView)findViewById(R.id.employee_order_items_recycler_view);
        ...
        if(orderStatus == 4 || orderStatus == 3) {
            ...
            toolbarBackButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(OrderItemEmployeeSide.this, MainActivityEmployeeSide.class);
    ...
    private void setToolbar(){
        androidx.appcompat.widget.Toolbar myToolbar = (Toolbar) findViewById(R.id.employee_order_items_toolbar);
        setSupportActionBar(myToolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(false);
        getSupportActionBar().setDisplayShowTitleEnabled(false);

        TextView mTitle = (TextView) myToolbar.findViewById(R.id.employee_order_items_toolbar_title);
        mTitle.setText(Integer.toString(orderId));

        toolbarBackButton = (ImageButton)myToolbar.findViewById(R.id.employee_order_items_toolbar_back_btn);
    ...
    private void populateOrderInfo(){
        ...
        FirebaseDatabase.getInstance().getReference("Users").child(customerUid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                customerNameTv.setText(tempInfo.getFirstName() + " " + tempInfo.getLastName());
                customerEmailTv.setText(tempInfo.getEmail());
